"""RESIF (Revolutionary EasyBuild-based Software Installation Framework) is
designed to easily setup, build a set of software (defined through software
sets) and deploy them either locally or within a High Performance Computing
(HPC) facility.
